...
ifeq ($(mode),d)
	...
	LDFLAGS = -g -fPIC -L$(LIB_DIR) -lpthread -llogger -lcommon -lframe -lnetevent -lframe -ltinyxml -lhiredis -lrt -levent
	RELEASE_TARGET = $(BIN_DIR)/account$(BIN_SUFFIX)
	TARGET	= $(RELEASE_TARGET)
endif

SERVER_DIR = $(BASE_DIR)/account
...
SERVER_INCLUDE_DIR = $(BASE_DIR)/account
